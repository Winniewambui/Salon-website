...
const Navbar = () => {
  ...
  <h1 className='text-3xl font-bold text-orange-500'><Link to="/">shiphy&style</Link></h1>
...
<h1 className='text-3xl font-bold text-orange-500'><Link to="/">shiphy&style</Link></h1>
<li className='p-4 border-b border-orange-300'><Link to="/">Home</Link></li>
<li className='p-4 border-b border-orange-300'><Link to="/about">about</Link></li>
<li className='p-4 border-b border-orange-300'><Link to ="/services">services</Link></li>
<li className='p-4 border-b border-orange-300'><Link to="footer">footer</Link></li>
