...
<ul className='hidden capitalize font-Poppins md:flex items-center p-8'>
...
<li className='p-4 border-b border-orange-300 capitalize'><Link to="footer">contact</Link></li>
