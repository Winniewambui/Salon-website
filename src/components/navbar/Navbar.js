...
const Navbar = () => {
  ...
  return (
    <div className='bg-white dark:bg-black flex justify-between items-center h-24 max-w-[1000px] mx-auto px-4'>
...
<li className='p-4 border-b border-orange-300 capitalize dark:text-white'><Link to="footer">contact</Link></li>
